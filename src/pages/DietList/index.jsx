...
function DietList() {
	return (
		<div className='container mt-10 mb-10 shadow-lg rounded-lg mx-auto px-1 py-2.5 max-w-sm md:max-w-2xl lg:max-w-4xl bg-burnt-sienna-100 md:mt-36'>
			<div className='text-3xl font-black text-center text-burnt-sienna-500 '>
				<h1>Diyet Listesi</h1>
			</div>

			<div className='max-w-lg px-10 mx-auto mt-10 text-2xl font-bold text-burnt-sienna-400'>
