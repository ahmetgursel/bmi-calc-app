	...
	return (
		<div className='flex'>
			<div className='text-center'>
				<svg className='mx-auto overflow-visible' width='9em' viewBox={[-1, -1, 2, 1].join(' ')}>
					<defs>
				...
				<div className='mt-4 text-5xl font-black tabular-nums slashed-zero'>{format(',')(value)}</div>
				<div className='text-xl font-black'>kg/m2</div>
				{!!label && (
					<div className={`mt-4 text-lg font-bold text-transparent bg-clip-text bg-gradient-to-br ${color}`}>
						{label}
					</div>
				)}
			</div>
